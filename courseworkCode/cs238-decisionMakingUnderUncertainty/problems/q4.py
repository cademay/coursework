...
uniform_b = [0.25, 0.25, 0.25, 0.25]

# observing a single successful catch with a = 30
a = 30
o = 1

new_belief = update_belief(a, o, uniform_b)

print(sum(new_belief))
