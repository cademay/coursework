...
def selectAction(b, d, acts, obs):

	if d == 0:
		return (None, 0, acts, obs)
	...
	for a in A:
		...
		for o in range(2):
			...
			if d == 3:
				...
				a_prime, u_prime, x, e = selectAction(b_prime, d - 1, acts1, obs1)

				aps.append((a_prime, u_prime))
